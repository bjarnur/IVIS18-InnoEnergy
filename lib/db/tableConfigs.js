...
const tableConfigs = {
  ...
  building_info : {
    ...
    "createStatement": "CREATE TABLE building_info (id, fuse, additional_info, subscription, address)",
    ...
    "insertRunStatement" : function(stmt, fields, i){
      stmt.run(fields[i].id, fields[i].fuse, fields[i].additional_info, fields[i].subscription, fields[i].address)
    }
  }
